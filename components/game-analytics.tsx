    ...
    <div className="space-y-8">
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-5">
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-blue-50 to-blue-100">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-blue-700">Total Games Played</CardTitle>
          ...
          <CardContent className="pt-0">
            <div className="text-3xl font-bold text-blue-800 mb-1">{metrics.totalGamesPlayed.toLocaleString()}</div>
            <p className="text-sm text-blue-600">Daily word puzzles solved</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-green-50 to-green-100">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-green-700">Contract Interactions</CardTitle>
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-sm text-green-600">Blockchain transactions</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-purple-50 to-purple-100">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-purple-700">Unique Players</CardTitle>
          ...
          <CardContent className="pt-0">
            ...
            <p className="text-sm text-purple-600">Distinct wallet addresses</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-orange-50 to-orange-100">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-orange-700">Games Per Player</CardTitle>
          ...
          <CardContent className="pt-0">
            <div className="text-3xl font-bold text-orange-800 mb-1">{metrics.playsPerPlayer.toFixed(1)}</div>
            <p className="text-sm text-orange-600">Average engagement</p>
          </CardContent>
        </Card>
        ...
        <Card className="border-0 shadow-lg hover:shadow-xl transition-shadow bg-gradient-to-br from-red-50 to-red-100">
          <CardHeader className="pb-3">
            <div className="flex items-center justify-between">
              <CardTitle className="text-sm font-medium text-red-700">Registered Players</CardTitle>
          ...
          <CardContent className="pt-0">
            <div className="text-3xl font-bold text-red-800 mb-1">{metrics.registeredPlayers.toLocaleString()}</div>
            <p className="text-sm text-red-600">Active accounts</p>
          </CardContent>
        </Card>
      </div>
              ...
              {metrics.topPlayers.slice(0, 5).map((player, index) => (
                <div key={player.address} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg">
                  <div className="flex items-center gap-3">
                    <Badge
                      variant="outline"
                      className={`w-8 h-8 p-0 flex items-center justify-center text-xs font-bold ${
                        index === 0
                    ...
                    <div>
                      ...
                      <p className="text-sm text-gray-500">Win rate: {player.winRate.toFixed(1)}%</p>
                    </div>
                  </div>
                  <div className="text-right">
                    <p className="font-bold text-gray-800">{player.gamesPlayed}</p>
